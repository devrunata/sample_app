...
describe User do
  before{ @user=User.new( :name=>"Example User",:email=>"example@gmx.de",
  ...
  describe "it should reject email adresses indentical up to case" do
    before do
      user_with_same_email=@user.dup
  ...
  describe "when password doesend match confirmation" do
  ...
  describe "return value of of authenticate method" do
    before{ @user.save }
